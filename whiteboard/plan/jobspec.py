...
def render_job_spec(
    ...
    sections = [
        ...
        *goal_lines,
        ...
        f"`mcp__whiteboard__write_agent_diagram(agent_id={aid_arg}, mermaid=<flowchart TD ...>)`.",
        ...
        f"- It is written to `{agent_dir / 'diagrams.md'}`. Rewriting it replaces the first fence; "
        "nothing else in the file is touched.",
        "- Do not write `plan/hld.md`, `plan/lld.md` or `plan/er.md`: those are the root's boards and "
        "the human approves every change to them.",
        "",
        "## Progress reporting",
        "",
